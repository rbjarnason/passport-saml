...
SAML.prototype.initialize = function (options) {
  ...
  console.log("PASSPORT DEBUG callbackUrl: "+options.callbackUrl);
  console.log("PASSPORT DEBUG issuer: "+options.issuer);

  if (options.identifierFormat === undefined) {
    options.identifierFormat = "urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress";
  }

  if (options.identifierFormat === 'unspecified') {
    options.identifierFormat = undefined;
  }

  console.log("PASSPORT DEBUG options.identifierFormat: "+options.identifierFormat);
