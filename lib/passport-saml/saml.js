...
SAML.prototype.initialize = function (options) {
  ...
  console.log("PASSPORT CERT: "+options.cert);
...
SAML.prototype.validatePostResponse = function (container, callback) {
  ...
  .then(function(certs) {
    ...
    console.log("PASSPORT: 3 valid: "+validSignature);
    ...
    if (assertions.length == 1) {
      if (self.options.cert &&
        ...
        console.log("PASSPORT: 4a");
        throw new Error('Invalid signature');
      }
      console.log("PASSPORT: 4b");
    ...
    console.log("PASSPORT: 10");
  })
  .fail(function(err) {
    console.log("PASSPORT: 11 err: "+err);
...
SAML.prototype.processValidlySignedAssertion = function(xml, inResponseTo, callback) {
  console.log("PASSPORT: PROCESS 1");
  ...
  .then(function(doc) {
    ...
    console.log("PASSPORT: PROCESS 2");
  ...
  .then(function(){
    console.log("PASSPORT: PROCESS 3");
    ...
    console.log("PASSPORT: PROCESS 4");
    ...
    console.log("PASSPORT: PROCESS 5");

    callback(null, profile, false);
  })
  .fail(function(err) {
    console.log("PASSPORT: PROCESS 6 err: "+err);
    callback(err);
  })
  .done();
};
